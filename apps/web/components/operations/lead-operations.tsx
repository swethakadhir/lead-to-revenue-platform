...
import { appointmentTypes as parseAppointmentTypes } from "@/lib/domain/configuration/dynamic-fields";
import type { Json } from "@/lib/supabase/database.types";

export function LeadOperations({ leadId, contactId, appointments, followups, references, timezone, canOperate, appointmentTypes }: { leadId: string; contactId: string | null; appointments: Appointment[]; followups: Followup[]; references: OperationalReferences; timezone: string; canOperate: boolean; appointmentTypes: Json }) {
